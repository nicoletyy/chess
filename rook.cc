...
Rook::Rook(shared_ptr<Cell> location, Colour colour): Piece{location, colour, 4}, checkCastling{true} {}



void Rook::moveIn(int row, int col) {
...
void Rook::notifyIn(Subject<Info> &whoFrom) {
...
void Rook::notifyOut(Subject<Info> &whoFrom) {
